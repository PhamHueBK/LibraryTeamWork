...
<head>
    ...
    <script type="text/javascript" src="View/js/process.js"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i><?php echo " ".$_SESSION['admin']['tenNhanVien']." ";?>
                    </a>
                </li>
                <li>
                    <a href="?mode=user&act=logout"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                </li>
                <!-- /.dropdown -->
            </ul>
            <!-- /.navbar-top-links -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?mode=post&act=index">Quản lý bài đăng</a>
                                </li>
                                <li>
                                    <a href="?mode=reader&act=index">Thống kê bạn đọc</a>
                                </li>
                                <li>
                                    <a href="?mode=review&act=index">Quản lý phản hồi từ độc giả</a>
                                </li>
                                <li>
                                    <a href="?mode=book&act=index">Quản lý sách</a>
                                </li>
                                <li>
                                    <a href="?mode=user&act=index">Quản lý người dùng khác</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
